...
#
# weblogic.py
# Search SHODAN for Weblogic Potential RCE
#
...
# Configuration
API_KEY = "YOURAPIKEY"
SEARCH_FOR = 'product:"Oracle Weblogic" port:"7001" country:"US"'
FILE = "/ws_utc/config.do"
...
def grab_file (IP,PORT,FILE):
	...
	try:
		...
		if '<title>settings</title>' in result:
			text_file = open("./cfg/weblogic.txt", "a")
			text_file.write(""+URL+"\n")
			text_file.close()
			print ("[*] WebLogic... Found [*]\n")
			print (result)
		else:
