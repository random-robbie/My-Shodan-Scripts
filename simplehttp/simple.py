...
# Configuration
API_KEY = "YOURAPIKEY"
SEARCH_FOR = 'product:"SimpleHTTPServer"'
FILE = "/"
...
def grab_file (IP,PORT,FILE):
	...
	try:
		...
		if response.status_code == 200:
			if 'Directory listing for /' in result:
				text_file = open("SimpleHTTP.cfg", "a")
				text_file.write("http://"+IP+":"+PORT+"\n")
				text_file.close()
				print ("[*] SimpleHTTP... Found [*]\n")
				print (result)
		else:
